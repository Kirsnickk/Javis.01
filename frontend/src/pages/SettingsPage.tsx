      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="flex flex-col gap-4">
          ...
          <Section title="Models">
            ...
            <SettingRow label="Cloud providers" description="Green dot means API key is configured">
              <div className="flex flex-wrap gap-3">
                ...
                <CloudProviderStatus label="DeepSeek" storageKey="openjarvis-deepseek-key" />
          ...
          <Section title="API Keys">
            <SettingRow label="OpenAI" description="GPT-4o, GPT-5, o3, o4">
              <ApiKeyInput storageKey="openjarvis-openai-key" placeholder="sk-..." />
            </SettingRow>
            <SettingRow label="Anthropic" description="Claude Sonnet, Opus, Haiku">
              <ApiKeyInput storageKey="openjarvis-anthropic-key" placeholder="sk-ant-..." />
            </SettingRow>
            <SettingRow label="Google" description="Gemini Pro, Flash">
              <ApiKeyInput storageKey="openjarvis-gemini-key" placeholder="AI..." />
            </SettingRow>
            <SettingRow label="DeepSeek" description="DeepSeek Chat, Reasoner, Coder">
              <ApiKeyInput storageKey="openjarvis-deepseek-key" placeholder="sk-..." />
            </SettingRow>
            <SettingRow label="Mistral" description="Mistral Large, Codestral, Pixtral">
              <ApiKeyInput storageKey="openjarvis-mistral-key" placeholder="..." />
            </SettingRow>
            <SettingRow label="xAI (Grok)" description="Grok 3, Grok 3 Mini">
