...
const CATALOGUE_MODELS = [
  ...
  { id: 'llama3.1:70b', size: '~40 GB', desc: 'Llama 3.1 70B — powerful' },
  // Gemma
  { id: 'gemma3:latest', size: '~3.3 GB', desc: 'Gemma 3 4B' },
  { id: 'gemma3:12b', size: '~8 GB', desc: 'Gemma 3 12B' },
  { id: 'gemma3:27b', size: '~17 GB', desc: 'Gemma 3 27B' },
  // DeepSeek
  { id: 'deepseek-r1:7b', size: '~4.7 GB', desc: 'DeepSeek R1 7B — reasoning' },
  { id: 'deepseek-r1:14b', size: '~9.0 GB', desc: 'DeepSeek R1 14B' },
  { id: 'deepseek-r1:32b', size: '~20 GB', desc: 'DeepSeek R1 32B' },
  { id: 'deepseek-coder-v2:latest', size: '~8.9 GB', desc: 'DeepSeek Coder V2 16B' },
  // Mistral / Mixtral
  { id: 'mistral:latest', size: '~4.1 GB', desc: 'Mistral 7B' },
  { id: 'mixtral:latest', size: '~26 GB', desc: 'Mixtral 8x7B MoE' },
  { id: 'mistral-nemo:latest', size: '~7.1 GB', desc: 'Mistral Nemo 12B' },
  // Phi
  { id: 'phi4:latest', size: '~9.1 GB', desc: 'Phi-4 14B' },
  { id: 'phi3:mini', size: '~2.3 GB', desc: 'Phi-3 Mini 3.8B' },
  { id: 'phi3:medium', size: '~7.9 GB', desc: 'Phi-3 Medium 14B' },
  // Code models
  { id: 'codellama:latest', size: '~3.8 GB', desc: 'Code Llama 7B — code gen' },
  { id: 'codellama:34b', size: '~19 GB', desc: 'Code Llama 34B' },
  { id: 'starcoder2:latest', size: '~3.8 GB', desc: 'StarCoder2 7B — code' },
  // Other
  { id: 'command-r:latest', size: '~20 GB', desc: 'Cohere Command R 35B' },
  { id: 'yi:latest', size: '~3.5 GB', desc: 'Yi 1.5 6B' },
  { id: 'solar:latest', size: '~6.1 GB', desc: 'Solar 10.7B' },
  { id: 'dolphin-mixtral:latest', size: '~26 GB', desc: 'Dolphin Mixtral 8x7B — uncensored' },
];
...
const CLOUD_PROVIDERS: CloudProvider[] = [
  {
    ...
    models: [
      ...
      { id: 'gpt-4-turbo', desc: 'GPT-4 Turbo — strong reasoning' },
      { id: 'gpt-5', desc: 'GPT-5 — most capable' },
      { id: 'gpt-5-mini', desc: 'GPT-5 Mini — reasoning, efficient' },
      { id: 'o3-mini', desc: 'o3-mini — reasoning' },
      { id: 'o3', desc: 'o3 — advanced reasoning' },
      { id: 'o4-mini', desc: 'o4-mini — latest reasoning' },
    ],
  },
  {
    name: 'Anthropic',
    ...
    models: [
      ...
      { id: 'claude-sonnet-4-20250514', desc: 'Claude Sonnet 4 — previous gen' },
      { id: 'claude-opus-4-20250514', desc: 'Claude Opus 4 — previous gen' },
    ],
  },
  {
    name: 'Google',
    ...
    models: [
      ...
      { id: 'gemini-3-flash', desc: 'Gemini 3 Flash — latest fast' },
      { id: 'gemini-3.1-pro-preview', desc: 'Gemini 3.1 Pro Preview — bleeding edge' },
    ],
  },
  {
    name: 'DeepSeek',
    ...
    models: [
      { id: 'deepseek-chat', desc: 'DeepSeek Chat — general purpose' },
      { id: 'deepseek-reasoner', desc: 'DeepSeek Reasoner — chain-of-thought' },
      { id: 'deepseek-coder', desc: 'DeepSeek Coder — code generation' },
    ],
  },
  {
    name: 'Mistral',
    ...
    models: [
      { id: 'mistral-large-latest', desc: 'Mistral Large — most capable' },
      { id: 'mistral-small-latest', desc: 'Mistral Small — fast & cheap' },
      { id: 'codestral-latest', desc: 'Codestral — code specialist' },
      { id: 'pixtral-large-latest', desc: 'Pixtral Large — multimodal' },
      { id: 'ministral-8b-latest', desc: 'Ministral 8B — edge' },
    ],
  },
  {
    name: 'xAI (Grok)',
    ...
    models: [
      { id: 'grok-3', desc: 'Grok 3 — most capable' },
      { id: 'grok-3-mini', desc: 'Grok 3 Mini — fast reasoning' },
      { id: 'grok-2', desc: 'Grok 2 — previous gen' },
    ],
  },
  {
    name: 'Groq',
    ...
    models: [
      { id: 'meta-llama/llama-4-scout-17b-16e-instruct', desc: 'Llama 4 Scout 17B — latest Meta, multimodal' },
      { id: 'llama-3.3-70b-versatile', desc: 'Llama 3.3 70B — versatile, high quality' },
      { id: 'llama-3.1-8b-instant', desc: 'Llama 3.1 8B — instant speed' },
      { id: 'qwen/qwen3-32b', desc: 'Qwen 3 32B — reasoning, multilingual' },
      { id: 'openai/gpt-oss-120b', desc: 'GPT OSS 120B — largest open-source' },
      { id: 'openai/gpt-oss-20b', desc: 'GPT OSS 20B — efficient open-source' },
      { id: 'groq/compound', desc: 'Compound AI — agentic, tool use' },
      { id: 'groq/compound-mini', desc: 'Compound Mini — fast agentic' },
    ],
  },
  {
    name: 'Cohere',
    ...
    models: [
      { id: 'command-r-plus', desc: 'Command R+ — RAG optimized' },
      { id: 'command-r', desc: 'Command R — efficient' },
      { id: 'command-a', desc: 'Command A — latest' },
    ],
  },
  {
    name: 'OpenRouter',
    ...
    models: [
      ...
      { id: 'openrouter/x-ai/grok-3', desc: 'Grok 3 via OpenRouter' },
      { id: 'openrouter/meta-llama/llama-3.3-70b-instruct', desc: 'Llama 3.3 70B via OpenRouter' },
    ],
  },
];
